...
<div class="card bg-light mb-3">
  ...
  <div class="card-body">
    ...
    <div class="row">
    <div class="col-sm-8" >
<div id="remoteVideo" class="card img-fluid" style="width:320px; height:240px; background:url('../images/nosignal.gif'); border: 0px double black;"> 
</div>
<br>
...
<div class="modal fade" id="modalanketa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="/fw/userpage/index" method="POST">
