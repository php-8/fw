...
class display extends AppModel {
    ...
    public function saveuserdata($userid, $firstname, $lastname, $gender, $age, $country, $city, $about) {
        ...
        $db = null;
    if($count>0) {
        $query = $this->dbconnect->prepare("UPDATE anketa SET firstname = :firstname, lastname = :lastname, gender = :gender, age = :age, country = :country, city = :city, about = :about WHERE userid=:userid");
        ...
        $query = $this->dbconnect->prepare("INSERT into anketa (`userid`,`firstname`,`lastname`,`gender`,`age`,`country`,`city`,`about`) VALUES(:userid,:firstname,:lastname,:gender,:age,:country,:city,:about)");
