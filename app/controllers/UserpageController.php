...
class  UserpageController extends AppController  {
    ...
    public function indexAction() {
        ...
        if(isset($_POST['save'])) {
            ...
            $savedata->saveuserdata($_SESSION['user']['id'], $_POST['firstname'], $_POST['lastname'], $_POST['gender'], $_POST['age'], $_POST['country'], $_POST['city'],$_POST['userinfo']);
            redirect('/fw/userpage/index');
        }
